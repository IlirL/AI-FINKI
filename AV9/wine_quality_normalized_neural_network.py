...
if __name__ == '__main__':
    ...
    print(f'Bez normalizacija imame tochnost so validacisko monzestvo od {val_acc1}')
    ...
    print(f'So min-max skaliranje imame tochnost so validacisko mnozestvo odd {val_acc3}')
